...
export const DataApiConfigLive = Layer.effect(
  ...
  Config.all({
    ...
    timeoutMs: Config.number("DATA_API_TIMEOUT_MS").pipe(Config.withDefault(30000)),
    cacheTtl: Config.duration("DATA_API_CACHE_TTL").pipe(Config.withDefault(Duration.minutes(5))),
  }),
);
